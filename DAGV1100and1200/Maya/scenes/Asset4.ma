...
//Name: Asset4.ma
//Last modified: Wed, Dec 03, 2025 02:57:12 PM
//Codeset: 1252
...
fileInfo "UUID" "6B1F7B6E-4528-BDE4-98D2-FEA33BFD0803";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "588B1250-4D2A-AB81-3B0F-34A13EFC4987";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -13.259146217606199 -1.4076395927139183 -13.486680107520151 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 20.070962726956161;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "E7D12562-46A1-C8FE-5A5C-449AFE11F094";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "7E04CC20-4E5C-D05E-2D56-C09296351821";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "7FD657DF-4A39-E767-0D5B-559A5660BBE4";
createNode displayLayerManager -n "layerManager";
	rename -uid "1D557099-47B6-EBD3-3662-DD9C7A1A1422";
createNode displayLayer -n "defaultLayer";
	rename -uid "39538FA8-4548-8A04-425D-B9AF6DF85836";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "99356DCA-4244-840D-311A-8EAA5E738112";
