...
//Name: Asset4.ma
//Last modified: Thu, Dec 04, 2025 09:23:29 PM
//Codeset: 1252
requires maya "2026";
...
fileInfo "UUID" "035F612D-4373-1A0D-C453-199E1330815E";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "588B1250-4D2A-AB81-3B0F-34A13EFC4987";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.42950989255445449 8.4544841941578763 10.505207015428821 ;
	setAttr ".r" -type "double3" -22.538352729499429 -353.39999999977096 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "806C108C-4791-B83B-0E1B-ABA90B9F4BDC";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 10.365967935897523;
...
createNode mesh -n "pasted__pCubeShape17" -p "pasted__pCube17";
	...
	setAttr -s 33 ".pt[2:34]" -type "float3"  -5.9604645e-08 0 0 -5.9604645e-08 
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "E0946B82-4E08-73CB-53AF-F7B413FEDA8D";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "1E222055-416C-E0E3-0F98-CE992E04AA7B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "5451DFAC-411C-A27B-5889-54A118735A15";
createNode displayLayerManager -n "layerManager";
	rename -uid "6BCF37FE-4572-8E58-8E2F-148ACCA262E4";
createNode displayLayer -n "defaultLayer";
	rename -uid "39538FA8-4548-8A04-425D-B9AF6DF85836";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "85092605-424D-E378-EE13-C38459773867";
